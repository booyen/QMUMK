...
<div class="panel-heading theme-medicines"><span class="inlineicon medicine-mini">Direktori stok ubat-ubatan</span></div>
...
<ol class="breadcrumb link-medicines">
  ...
  <li class="active">Direktori ubat</li>
</ol>

	<?php if(isset($_GET['deleted'])){$deleted=$_GET['deleted'];?>
    <div class='alert alert-success' role='alert'>Berjaya dipadam!</div>
	<?php }?>
