...
<div class="panel-heading theme-medicines"><span class="inlineicon edit-mini">Daftar ubat</span></div>
<div class="panel-body">
<ol class="breadcrumb link-medicines">
  <li><a href="../dashboard">Laman utama</a></li>
  <li><a href="../medicines/">Direktori ubat</a></li>
  <li class="active">Ubat baru</li>
</ol>
<?php
if(isset($_POST['submit'])){
	...
	$frequency=friendly($_POST['frequency']);
	$condition=friendly($_POST['condition']);
	$usage=friendly($_POST['usage']);
...
<form method="post" action="" enctype="multipart/form-data">
	<div class="form-group"><label>Kategori ubat:</label><select class="form-control"  name='category'  id='category' size='1' tabindex='1'>
            <option value='Kumur'>Ubat Kumur</option>
            <option value='Titik/Sapu'>Ubat Titik/Sapu</option>
			<option value='Sapu'>Ubat Sapu(poison)</option>
			<option value='Tablet'>Tablet</option>
	</select></div>

	<div class="form-group"><label>Kekerapan ubat:</label><select class="form-control"  name='frequency'  id='frequency' size='1' tabindex='1'>
	...
	<div class="form-group"><label>Pengunaan:</label><select class="form-control"  name='condition'  id='condition' size='1' tabindex='1'>
...
<div class="form-group"><label>Cara penggunaan:</label><select class="form-control"  name='usage'  id='usage' size='1' tabindex='1'>
	...
	<div class="form-group"><label>Kod Ubat:</label><input class="form-control"  name="code" type="text" maxlength="10" /></div>
	<div class="form-group"><label>Nama ubat:</label><input class="form-control"  name="name" type="text" maxlength="30" /></div>
	<div class="form-group"><label>Harga:</label><input class="form-control"  name="price" type="text" maxlength="10" /><i>e.g: Harga per tablet/botol</i></div>
