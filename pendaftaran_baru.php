...
(("0"+(dt.getMonth()+1)).slice(-2)) +"/"+
 ...
 +":"+ (("0"+dt.getMinutes()).slice(-2));
  ...
  <div class="col-md-12  header-menu ">
      <h1 style="color:#000;"> Pendaftaran pesakit baru</h1>
  ...
  <div class="col-md-9 ">
      ...
      <form  autocomplete="off" id="main-part" >
          
           <div class="form-group">
    <label for="inputAddress">Nama Penuh</label>
    <input autocomplete="off" required type="text" class="form-control" id="inputAddress" placeholder="Masukkan nama penuh anda">
  </div>
  <div class="form-row">
   ...
   <div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputCity">No Telefon</label>
      <input type="number" class="form-control" id="inputCity" placeholder="012345678" >
    </div>
    <div class="form-group col-md-4">
      <label for="inputJantina">Jantina</label>
      <select id="inputJantina" class="form-control">
    ...
    <div class="form-group col-md-4">
      <label for="inputBangsa">Bangsa</label>
      <select id="inputBangsa" class="form-control">
        <option selected>Pilih bangsa..</option>
        <option>Cina</option>
