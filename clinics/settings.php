...
<div class="panel-heading theme-branches"><span class="inlineicon settings-mini">Tetapan</span></div>
...
<form method="post" action="" enctype="multipart/form-data">
	...
	<h3>Tetapan Sistem Umum</h3>
	<div class="form-group"><label>Nama Sistem:</label><input class="form-control" name="portal_name" type="text" value="<?php echo $global->portal_name;?>" /><i>Nama sistem</i></div>
	<div class="form-group"><label>Nama Pendek:</label><input class="form-control" name="guardian_short_name" type="text" value="<?php echo $global->guardian_short_name;?>" /><i>Nama Pendek</i></div>
	<div class="form-group"><label>Dibawah organisasi:</label><input class="form-control" name="guardian_name" type="text" value="<?php echo $global->guardian_name;?>" /><i>Nama organisasi</i></div>
    <hr/>

    <h3 style="margin-top:50px;">Permissions (Tetapan akses)</h3>
    <p>Disini untuk menukar akses sistem berdasarkan pengguna. Siapa yang dapat melihat maklumat @ page qmedic. Jika anda mengalami kesukaran, sila hubungi Devloper Qmedic Di CCI UMK Jeli untuk penerangan dan pertanyaan.</p>
	
	<div class="form-group"><label>Pendaftaran pesakit boleh dilakukan oleh:</label><select class="form-control" name='register_patient'  id='register_patient' size='1' tabindex='1'>
    ...
    </select><i>Pengguna yang paling rendah akan dapat mendaftarkan pesakit</i></div>

	<div class="form-group"><label>Memberi preskripsi/ merawat pesakit:</label><select class="form-control" name='prescribe_patient'  id='prescribe_patient' size='1' tabindex='1'>
            ...
            <option value='4'>4 - <?php echo access_level2rank(4);?></option>
            <option value='5'>5 - <?php echo access_level2rank(5);?></option>
    </select><i>Preskripsi ubat kepada pesakit dan dan merawat pesakit</i></div>
    
	<div class="form-group"><label>Direktori Pesakit:</label><select class="form-control" name='patients_directory'  id='patients_directory' size='1' tabindex='1'>
            ...
            <option value='4'>4 - <?php echo access_level2rank(4);?></option>
            <option value='5'>5 - <?php echo access_level2rank(5);?></option>
    </select><i>Melihat maklumat pesakit yang berdaftar</i></div>
