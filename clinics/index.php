...
<div class="panel-heading theme-branches"><span class="inlineicon network-mini">Klinik</span></div>
...
<ol class="breadcrumb link-branches">
  ...
  <li class="active">Klinik</li>
    ...
    <div  class="alert alert-success" role="alert">Maklumat klinik telah berjaya dipadam!</div>
	<?php }?>
...
?>
	...
	<div class="panel panel-default profile-card profile-branch">
	  ...
	  <div class="panel-body">
		...
		<p><i class="material-icons ">location_on</i> <b>Lokasi:</b> <?php echo substr($clinics['address'], 0,16);?>, <?php echo $clinics['location']?></p>
		<p><i class="material-icons">phone</i> <b>No tel:</b> <?php echo $clinics['contact']?></p>
	  </div>
	</div>
	</a>
