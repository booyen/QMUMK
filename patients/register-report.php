...
<div class="panel-heading theme-patients"><span class="inlineicon edit-mini">Laporan baru</span></div>
...
?>
	<?php if($success==true){?>
	<div class="alert alert-success" role="alert">Pendaftaran berjaya. Sila isi Maklumat penyakit dibawah</div> 
	<?php }?>
